...
El archivo "ModeloSOR1.ipynb" corresponde al código utilizado para $u(x,y)$ constante y el archivo "ModeloSOR2.ipynb" corresponde a $u(x,y)$ variable en función de la profundidad en x. Ambos códigos estan en formato Jupyter y se ejecutan de igual manera.
